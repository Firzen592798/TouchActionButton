...
{
	return {
		"name":			"Touch Action Button",				// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"TouchActionButton",				// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"create a action touch button to use in mobile games",
...
// example				
AddCondition(0, cf_trigger, "On button pressed", "Input", "Button pressed", "Triggered when the button is touched or clicked", "OnButtonPressed");
AddCondition(1, cf_trigger, "On button relased", "Input", "Button released", "Triggered when the button is released", "OnButtonReleased");
AddCondition(2, cf_none, "On button hold", "Input", "Button hold", "Triggered when the player is holding the button", "OnButtonHold");
////////////////////////////////////////
// Actions
...
var property_list = [
	new cr.Property(ept_color, "PressedColor", "rgb(20,20,20)", "Define the gradient color of the button when pressed"),
